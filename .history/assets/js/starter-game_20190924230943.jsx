...
//Randomize an array: https://stackoverflow.com/questions/2450954/how-to-randomize-shuffle-a-javascript-array 
  boardGenerator() {
	...
	return <div class = "wrap">
		...
		<Row id="1" onClick={this.isNotSameClose(this.props.children)}>{this.state.array[1]}</Row>
		<Row id="2" onClick={this.isNotSameClose(this.props.children)}>{this.state.array[2]}</Row>
